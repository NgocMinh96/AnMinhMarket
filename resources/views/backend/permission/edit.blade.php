...
@section('wrapper')
    <div class="page-wrapper">
        <div class="page-content">
            ...
            {!! Form::breadcrumb('Thành Viên', ['Chức năng', 'Sửachức năng']) !!}
                    ...
                    <div class="card border-top border-0 border-4 border-primary">
                        <div class="card-body p-5">
                            <div class="card-title d-flex align-items-center">
                                <h5 class="mb-0 text-primary">Sửa chức năng</h5>
                            </div>
                            <hr>
                            <form action="{{ route('backend.permission.update', $data->id) }}" method="POST"
