! function (t, e) {
    ...
    e.locale("en"), t.fn[a] = function (e, a) {
        ...
        constructHTMLCalendar: function (t, i) {
            var a = "";
            a += '<div class="dtp-picker-month">' + t.locale(this.params.lang).format("LL") + "</div>", a += '<table class="table dtp-picker-days"><thead>';
            for (var s = 0; s < i.week.length; s++) a += "<th>" + e(parseInt(i.week[s]), "d").locale(this.params.lang).format("dd").substring(0, 2) + "</th>";
            a += "</thead>", a += "<tbody><tr>";
